"""Guarded correctness and lint repairs for the pinned upstream JavaScript."""
...
""",
    ...
    for old, new, label in (
        ("encryptedData['ciphertext']", "encryptedData.ciphertext", "encrypted payload dot notation"),
        ("encryptedData['nonce']", "encryptedData.nonce", "encrypted nonce dot notation"),
        ("encryptedData['tag']", "encryptedData.tag", "encrypted tag dot notation"),
        ("metadata['combinedRawPayloadSizeInBytes']", "metadata.combinedRawPayloadSizeInBytes", "P2P metadata dot notation"),
    ):
