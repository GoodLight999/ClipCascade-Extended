"""Integrate the bounded durable outbound queue into generated upstream code."""
...
''',
        '''        // Queue first; transport delivery is retried after reconnect/process restart.
