...
python3 "$ROOT_DIR/scripts/finalize_notification_localization.py" "$DESTINATION"
python3 "$ROOT_DIR/scripts/finalize_transport_delivery_semantics.py" "$DESTINATION"
python3 "$ROOT_DIR/scripts/guard_final_transport_delivery.py" "$DESTINATION"
python3 "$ROOT_DIR/scripts/finalize_android_lint.py" "$DESTINATION"
python3 "$ROOT_DIR/scripts/validate_kotlin_imports.py" "$DESTINATION"
...
python3 "$ROOT_DIR/scripts/validate_error_handler_supervision.py" "$DESTINATION"
python3 "$ROOT_DIR/scripts/validate_runtime_queue_admission.py" "$DESTINATION"
python3 "$ROOT_DIR/scripts/validate_runtime_transport_activity.py" "$DESTINATION"
python3 "$ROOT_DIR/scripts/validate_transport_delivery_semantics.py" "$DESTINATION"
python3 "$ROOT_DIR/scripts/validate_p2p_signaling_inputs.py" "$DESTINATION"
...
python3 "$ROOT_DIR/scripts/validate_notification_localization.py" "$DESTINATION"
